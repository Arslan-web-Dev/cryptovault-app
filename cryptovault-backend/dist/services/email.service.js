...
class EmailService {
    ...
    async sendEmail(options) {
        try {
            ...
            throw (0, error_middleware_1.createError)('Failed to send email', 500);
        }
    }
    async sendWelcomeEmail(email, fullName, verificationLink) {
    ...
    async sendSecurityAlert(email, securityData) {
        await this.sendEmail({
            to: email,
            template: 'security',
